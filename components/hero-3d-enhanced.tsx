...
export function Hero3DEnhanced() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      />
      <div
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[120px] animate-pulse [animation-delay:1000ms]"
        style={{
          transform: `translate(${mousePosition.x * -0.02}px, ${mousePosition.y * -0.02}px)`,
        }}
      />
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[150px] animate-pulse [animation-delay:500ms]"
        style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-card/50 backdrop-blur-md neon-border animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <span
              className="neon-text bg-clip-text transition-all duration-500"
              style={{
                transform: `perspective(1200px) rotateX(${mousePosition.y * 0.005}deg)`,
              }}
            >
              BLXK STUDIO
            </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
            <Button
              ...
              className="neon-glow bg-primary text-primary-foreground hover:bg-primary/90 text-lg px-8 transition-all hover:scale-110 active:scale-95"
            >
              Iniciar Proyecto
