...
export function BlxkChatbot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed inset-0 z-30 md:inset-auto md:bottom-24 md:right-8 md:w-96 md:max-h-[600px] flex items-end md:items-stretch justify-center md:justify-end p-4 md:p-0">
          <div
            className={`w-full h-full md:h-auto rounded-2xl md:rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 flex flex-col ${
