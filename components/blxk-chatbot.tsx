...
export function BlxkChatbot() {
  ...
  const { isDayMode } = useTheme() as any
                ...
                <div className="flex justify-start">
                  <div className={`px-4 py-2 rounded-lg ${isDayMode ? "bg-gray-200" : "bg-slate-700"}`}>
                    <div className="flex space-x-2">
                      ...
                      />
                      <div
                        className={`w-2 h-2 rounded-full animate-bounce delay-100 ${isDayMode ? "bg-gray-600" : "bg-cyan-400"
                          }`}
                      />
                      <div
                        className={`w-2 h-2 rounded-full animate-bounce delay-200 ${isDayMode ? "bg-gray-600" : "bg-cyan-400"
                          }`}
                      />
                    </div>
                  </div>
