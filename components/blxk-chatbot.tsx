...
export function BlxkChatbot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-20 right-4 z-30 flex items-end justify-end p-4 md:inset-auto md:bottom-8 md:right-8 md:w-96 md:max-h-[600px] md:flex md:items-stretch md:justify-end md:p-0">
          <div
